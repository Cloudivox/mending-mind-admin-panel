...
const Products = () => {
  return (
    <div id="webcrumbs" className="w-full min-h-screen bg-[#F7F9FC]">
      <div className="w-full p-8 bg-white shadow-md rounded-2xl min-h-screen">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8 mb-10">
          ...
          <div className="p-6 bg-[#F5E6FF] rounded-2xl hover:shadow-lg transition-all">
            <p className="text-sm font-montserrat mb-2 text-[#34495E]">Revenue</p>
          ...
          <div className="p-6 bg-[#FFF4E5] rounded-2xl hover:shadow-lg transition-all">
            <p className="text-sm font-montserrat mb-2 text-[#34495E]">Orders</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {["Trending Up", "Top Selling", "Not Selling"].map((title, idx) => (
            <div key={idx} className="bg-white rounded-2xl p-6 shadow-sm transition-all">
              ...
              <table className="w-full">
                ...
                <tbody>
                  {[
                    idx === 0
                      ? { name: "Product A", price: "$299", stat: "+45%", color: "text-green-500" }
                      : idx === 1
                      ? { name: "Product B", price: "$399", stat: "234" }
                      : { name: "Product C", price: "$499", stat: "-12%", color: "text-red-500" },
                    idx === 0
                      ? { name: "Product D", price: "$199", stat: "+32%", color: "text-green-500" }
                      : idx === 1
                      ? { name: "Product E", price: "$249", stat: "189" }
                      : { name: "Product F", price: "$349", stat: "-8%", color: "text-red-500" },
                  ].map((product, i) => (
                    <tr
                      key={i}
                    ...
                    >
                      ...
                      <td className="py-4 text-[#34495E] font-montserrat">{product.price}</td>
                      <td
                        className={`py-4 text-center font-montserrat font-medium ${product.color || "text-[#34495E]"}`}
                      >
                        {product.stat}
                      </td>
                    </tr>
