...
const SessionDetails = () => {
  ...
  const [sessionData, setSessionData] = useState({
    ...
    sessionDate: "March 4, 2025 • 2:00 PM",
    notes: [
      {
        id: 1,
        content:
          "Patient reported improved sleep patterns following last week's mindfulness exercises. Still experiencing anxiety in social situations but noted reduced intensity. We discussed continuing the breathing techniques and adding a journaling practice before bed.",
  ...
  const handleAddNote = () => {
    ...
    setSessionData({ ...sessionData, notes: updatedNotes });
    setNewNote("");
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button className="text-gray-400 hover:text-[#E07A5F]">
                        {/* Trash SVG */}
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
